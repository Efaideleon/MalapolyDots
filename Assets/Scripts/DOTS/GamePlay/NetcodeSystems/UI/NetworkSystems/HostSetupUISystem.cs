...
namespace DOTS.GamePlay.NetcodeSystems.UI.NetworkSystems
{
    ...
    public partial struct HostSetupUISystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            if (menuPhaseLookup[menuPhaseEntity].Value == GameMenuPhase.HostSetup)
            {
                ...
                if (panelsComponent.PanelLookup != null && panelsComponent.AllPanels != null)
                {
                    ...
                    {
                        UnityEngine.Debug.Log($"[HostSetupUISystem] | Hiding Panels");
                        panel.Hide();
                    }
                    panelsComponent.PanelLookup[GameMenuPhase.HostSetup].Show();
                    UnityEngine.Debug.Log($"[HostSetupUISystem] | Showing Host Setup Panel");
                }
            }
        }
    }
