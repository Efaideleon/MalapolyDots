    ...
    public class TreasureSpaceAuthoring : MonoBehaviour
    {
        ...
        class TreasureSpaceAuthoringBaker : Baker<TreasureSpaceAuthoring>
        {
            public override void Bake(TreasureSpaceAuthoring authoring)
            {
                ...
                // var animationsClips = builder.Allocate(ref root.Clips, Enum.GetValues(typeof(TreasureAnimation)).Length);
                //
                ...
                AddComponent(entity, new CurrentTreasureAnimation { Value = TreasureAnimation.Close });
