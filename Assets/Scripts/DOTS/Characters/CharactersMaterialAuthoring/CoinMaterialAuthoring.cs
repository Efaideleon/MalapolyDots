...
{
    public class CoinMaterialAuthoring : MonoBehaviour
    {
        ...
        class CoinMaterialBaker : Baker<CoinMaterialAuthoring>
        {
            public override void Bake(CoinMaterialAuthoring authoring)
            {
