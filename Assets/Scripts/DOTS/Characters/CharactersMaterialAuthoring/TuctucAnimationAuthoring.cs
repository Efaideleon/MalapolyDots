...
{
    public class TuctucAnimationAuthoring : MonoBehaviour
    {
        ...
        class TuctucAnimationBaker : Baker<TuctucAnimationAuthoring>
        {
            public override void Bake(TuctucAnimationAuthoring authoring)
            {
