...
{
    [CreateAssetMenu(fileName = "AnimationTreasureData", menuName = "Scriptable Objects/Animation/AnimationTreasureData")]
    public class AnimationTreasureDataSO : ScriptableObject
    {
