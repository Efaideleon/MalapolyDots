...
{
    public class LiraAnimationAuthoring : MonoBehaviour
    {
        ...
        class LiraAnimationBaker : Baker<LiraAnimationAuthoring>
        {
            public override void Bake(LiraAnimationAuthoring authoring)
            {
